...
def split_book_by_chapter(cleaned, book_title):
    """
    ...
    """
    # 1) split book into chapters and save it in a list with regex
    chapters = re.split(r'\b(?:CHAPTER|Chapter|Letter)\s+(?:\w+\.?\n+)', cleaned)[1:]
